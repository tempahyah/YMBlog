package ashimdevine.apps.ymblog.repository
...
import ashimdevine.apps.ymblog.util.Constants.Companion.NETWORK_TIMEOUT
import ashimdevine.apps.ymblog.util.Constants.Companion.TESTING_CACHE_DELAY
import ashimdevine.apps.ymblog.util.Constants.Companion.TESTING_NETWORK_DELAY
import ashimdevine.apps.ymblog.util.ErrorHandling.Companion.ERROR_CHECK_NETWORK_CONNECTION
import ashimdevine.apps.ymblog.util.ErrorHandling.Companion.ERROR_UNKNOWN
import ashimdevine.apps.ymblog.util.ErrorHandling.Companion.UNABLE_TODO_OPERATION_WO_INTERNET
import ashimdevine.apps.ymblog.util.ErrorHandling.Companion.UNABLE_TO_RESOLVE_HOST
